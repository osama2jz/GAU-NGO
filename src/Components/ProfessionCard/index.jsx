...
const Cards = ({ data }) => {
 ...
 return (
  <>
   <Card className={classes.card} shadow="lg" w={235} component="a" radius={26} withBorder>
    ...
    <Stack spacing="xs" mb="xs">
     ...
     <Grid>
      <Grid.Col span={6}>
       <Datepicker size="xs" icon={<CalendarEvent size={16} />} labelFormat={"DD/MM/YY"} />
      </Grid.Col>
      <Grid.Col span={6}>
    ...
    <Button label="Schedule" primary={true} className={classes.button} styles={{ width: "100%" }} />
   </Card>
  </>
 );
};
