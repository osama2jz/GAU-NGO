...
export const UserVerification = () => {
 ...
 const handleNextSubmit = () => {
  active < 4 ? setActive(active + 1) : navigate(routeNames.socialWorker.allUsers);
 };
 ...
 return (
  <Container className={classes.userVerification} size="lg">
   ...
   <Stepper
    ...
    <Stepper.Step label="1. Get Started" description="Personal Identification">
     <Step1 />
    </Stepper.Step>
    <Stepper.Step
    ...
    <Stepper.Step
     icon={<img src={step3} className={classes.stepIcon} width="40px" alt="icon" />}
     label="3. Consent Form"
     description="Consent Form">
     <Step3 />
    </Stepper.Step>
    <Stepper.Step
     icon={<img src={step4} className={classes.stepIcon} width="40px" alt="icon" />}
     label="4. Agreement"
     description="User Agreement">
     <Step4 />
    </Stepper.Step>
    <Stepper.Step
     icon={<img src={step5} className={classes.stepIcon} width="40px" alt="icon" />}
     label="5. Finish"
